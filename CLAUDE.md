...
**Formatting:** Spotless with Google Java Format (AOSP style) runs automatically at compile phase — run `./mvnw spotless:apply` before committing if the build fails on formatting.
